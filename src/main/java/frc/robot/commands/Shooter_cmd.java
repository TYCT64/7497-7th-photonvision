...
//     private final BooleanSupplier lb;
//     private final BooleanSupplier rb;
...
//     public Shooter_cmd(ShooterSubsystem shooterSubsystem,  BooleanSupplier lb,BooleanSupplier rb
//     ) {
...
//        if(rx.get() > 0.7){
//         shooterSubsystem.angleout(-1);
//         }else if(rx.get() < -0.7
        
//         ){
//             shooterSubsystem.angleout(1);
//         }else{
//             shooterSubsystem.angleout(0);
